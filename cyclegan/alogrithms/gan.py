...
class GAN:
  ...
  def train(self, x, y):
    ...
    self.G_optimizer.minimize(G_loss, self.G, tape)
    self.F_optimizer.minimize(F_loss, self.F, tape)
    self.X_optimizer.minimize(X_loss, self.X, tape)
    self.Y_optimizer.minimize(Y_loss, self.Y, tape)
